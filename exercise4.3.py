...
# train the model
model = Word2Vec(sentences=data_clean, window=5,
                 min_count=3, workers=4, epochs=5, sg=1)
...
print("\nMost similar words to bake: ")
print(model.wv.most_similar('bake', topn=15))

# returns the top ten most similar words to "recipe" that are dissimilar from "milk"
print("\nMost similar words to butter but dissimilar to salt")
print(model.wv.most_similar(positive=["butter"], negative=["salt"], topn=25))
...
print("\nCosine similarity between 'milk' and 'cream' ")
print(model.wv.similarity("milk", "cream"))

# returns a prediction for the other words in a set containing the words "flour," "eggs," and "cream"
print("\nPrediction for ['flour,'eggs','cream']: ")
print(model.predict_output_word(["flour", "eggs", "cream"]))
